...
getSimpleStatisticsFromUnpkg().then(x=>{
  ...
  document.head.innerHTML+=`<script src="https://d3js.org/d3.v7.min.js"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.4/Chart.js"></script>`

  import * as Chart from '/path/to/Chart.js';
...
/*
(async () => {
  const d3 = browser.extension.getURL('d3.v7.min.js');
  const Chart = browser.extension.getURL('Chart.js');
})(); 
